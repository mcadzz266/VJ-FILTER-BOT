...
API_ID = int(environ.get('API_ID', '18401114'))
API_HASH = environ.get('API_HASH', 'e9105cffc9ef49b4011dfeb843acb091')
BOT_TOKEN = environ.get('BOT_TOKEN', "6807022476:AAHVbcJ-Upt3xybtIj_niZIchL0cHV8iW7E")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001829805583'))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '684727861').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001749313075').split()]
